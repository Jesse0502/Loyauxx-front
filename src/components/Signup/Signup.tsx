...
import { signupDataStatic } from "../../api/indexApi";
...
function Signup() {
	...
	useEffect(() => {
		console.log("signupDataStatic");
		console.log(signupDataStatic);
		if (signupDataStatic && signupDataStatic === "Signup successful") {
			setLoginOrSignin(false);
		}
		// signupDataStatic.msg === "Signup successful";
		// setLoginOrSignin(true);
	});
					...
					<Stack py="5" w={{ lg: "80%", base: "90%" }} m="auto" h="max">
						...
						<Stack py="">
							{LoginOrSignin ? (
								...
								<Box mb="5">
									<SignupForm setLoginOrSignin={setLoginOrSignin} />
								</Box>
							)}
						</Stack>
					</Stack>
